...
/**
 * Parse extracted text into structured recipe data using AI
 */
...
export const processPDFRecipeBook = async (file, progressCallback) => {
  try {
    ...
    return {
      ...
      message: `Successfully extracted ${parsingResult.totalFound} recipes from ${extractionResult.totalPages} pages`
    };

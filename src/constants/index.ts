...
export const BASE_SPIRITS = [
  'All', 'Mocktail', 'Whiskey', 'Gin', 'Rum', 'Tequila', 'Vodka', 'Brandy',
  'Amari', 'Wine', 'Beer', 'Liqueur/Other'
];

// Mocktail-specific constants
export const MOCKTAIL_CATEGORIES = [
  'Fruit-Based', 'Herb-Infused', 'Sparkling', 'Creamy', 'Frozen', 'Hot', 'Layered', 'Classic Virgin'
];

export const ALCOHOL_CONTENT_TYPES = {
  ALCOHOLIC: 'alcoholic',
  NON_ALCOHOLIC: 'non_alcoholic',
  LOW_ALCOHOL: 'low_alcohol' // For future use (e.g., kombucha, low-ABV beer)
};
